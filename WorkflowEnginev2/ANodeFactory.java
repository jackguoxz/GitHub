...
//    `-----7
	...
	public static ANode createNode() {
        ...
        ANode node7 = new ANode(7, 2);
        ANode node8 = new ANode(8, 1);
        
        //node2.prev=node1;
        //node3.prev=node1;
        

        node1.setPostNodeList(Arrays.asList(node2, node3, node4,node8));
        node2.setPostNodeList(Arrays.asList(node5));
        node3.setPostNodeList(Arrays.asList(node5));
        //node4.setPostNodeList(Arrays.asList(node7));
        node4.setPostNodeList(Arrays.asList(node6));
        node8.setPostNodeList(Arrays.asList(node6));
